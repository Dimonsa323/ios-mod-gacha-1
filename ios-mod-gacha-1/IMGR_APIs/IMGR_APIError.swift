...
enum IMGR_APIError: Error {
    case checkUpdateError(type: IMGR_ContentType, errorDescription: String)
    case invalidURL
    case unexpectedResponse
    case noInternetConnection
    case qiblaWithoutLocation
    case parseError(IMGR_ContentType)
    case error(String)
}

extension IMGR_APIError: LocalizedError {
